...
python scripts/main.py train \
	...
	--train_filepath /tmp/paras/data_cache/codesearchnet_javascript/javascript_train_supervised.jsonl.gz \
	--eval_filepath /tmp/paras/data_cache/codesearchnet_javascript/javascript_valid_0.jsonl.gz
