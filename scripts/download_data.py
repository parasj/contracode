...
if __name__ == "__main__":
    ...
    cmds.append("gunzip -d {}".format(str(csn_base_dir / 'javascript_dedupe_definitions_nonoverlap_v2_train.jsonl.gz')))
    cmds.append("wget -nc -P {} {}".format(str(csn_base_dir), REMOTE_CSNJS_TEST))
    cmds.append("gunzip -d {}".format(str(csn_base_dir / 'javascript_test_0.jsonl.gz')))
    cmds.append("wget -nc -P {} {}".format(str(csn_base_dir), REMOTE_CSNJS_VALID))
    cmds.append("gunzip -d {}".format(str(csn_base_dir / 'javascript_valid_0.jsonl.gz')))
